...
*/
let year = "1999";
console.log('task 1c', year.toString());
...
function hungryDog(weightP,age){
  
  if(age >= 1 && weightP <= 5){
    return weightP * 0.05;
  }else if(age >= 1 && weightP >= 6 && weightP <= 10){
    return weightP * 0.04;
  }else if(age >= 1 && weightP >= 11 && weightP <= 15){
    return weightP * 0.03
  }else if(age >= 1 && weightP > 15){
    return weightP * 0.02
...
console.log(vowelCounter('Hello there, my name is Cannen.'));
